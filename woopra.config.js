!function() {
    var t, o, c, e = window, n = document, r = arguments, a = 'script', i = ['call', 'cancelAction', 'config', 'identify', 'push', 'track', 'trackClick', 'trackForm', 'update', 'visit'], s = function() {
...
woopra.config({
    domain: 'filetoolsioaltaccount.github.io',
